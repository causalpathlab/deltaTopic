...
#%%
savefile_name = f"models/SCVI_unspliced_ep{args.EPOCHS}_nlv{args.nLV}_bs{args.bs}_train_size{args.train_size}"
print(savefile_name)
...
#%%
#create our model
model = scvi.model.SCVI(adata_unspliced, n_latent = args.nLV)
#%%
