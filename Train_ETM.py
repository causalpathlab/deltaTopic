...
import wandb
wandb.login()
wandb.init(entity="thisisyichen", project="ETM")
# Input parser
...
#%%
savefile_name = f"models/ETM_allgenes_ep{args.EPOCHS}_nlv{args.nLV}_bs{args.bs}_combineby{args.combine_method}_lr{args.lr}_train_size{args.train_size}"
print(savefile_name)
...
model = ETM(adata_spliced, n_latent = args.nLV, combine_latent= args.combine_method)
#%%
# this has to be passed, otherwise pytroch lighting logging won't be passed to wandb
from pytorch_lightning.loggers import WandbLogger
wandb_logger = WandbLogger(project = 'ETM')
