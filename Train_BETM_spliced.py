...
#%%
savefile_name = f"models/BETM_spliced_ep{args.EPOCHS}_nlv{args.nLV}_bs{args.bs}_lr{args.lr}_train_size{args.train_size}_pip0rho_{args.pip0_rho}_klbeta_{args.kl_weight_beta}v1"
print(savefile_name)
...
model = BETM(adata_spliced, n_latent = args.nLV, pip0_rho=args.pip0_rho, kl_weight_beta = args.kl_weight_beta)
#%%
